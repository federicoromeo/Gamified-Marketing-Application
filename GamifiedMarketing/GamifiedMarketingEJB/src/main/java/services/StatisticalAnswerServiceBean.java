...
public class StatisticalAnswerServiceBean
{
     ...
     */
    public List<StatisticalAnswer> findStatisticalAnswerBySex(Sex sex)
    {
        return em
                .createNamedQuery("StatisticalAnswer.findAll", StatisticalAnswer.class)
                .getResultList()
     ...
     */
    public List<StatisticalAnswer> findStatisticalAnswerByExpertise(Expertise expertise)
    {
        return em
                .createNamedQuery("StatisticalAnswer.findAll", StatisticalAnswer.class)
                .getResultList()
     ...
     */
    public int createStatisticalAnswer(User user, Product product, Integer age, Sex sex, Expertise expertise)
    {
